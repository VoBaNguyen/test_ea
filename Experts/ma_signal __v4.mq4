...
//---
   ...
   for(int i=0; i<arrSize-1; i++) {
      ...
      bufRSI[i] = iRSI(NULL, TIME_FRAME, 20, PRICE_CLOSE,i);
   }
   ...
   double ADXFast = NormalizeDouble(bufADXFast[shift], _Digits);
   double ADXSlow = NormalizeDouble(bufADXSlow[shift], _Digits);
   double rsi = NormalizeDouble(bufRSI[shift], _Digits);
