...
void EvaluateEntry(){
   ...
   Alert("aaa");
   if(!IsSpreadOK) {
      Alert("Spread is too hight! No entry");
...
void ExecuteEntry(){
   ...
   if(SignalEntry==SIGNAL_ENTRY_BUY){
      ...
      StopLossPrice=OpenPrice - atr;
      TakeProfitPrice=OpenPrice + atr;
